...
<head>
    ...
    <link rel="stylesheet" href="<?= $cmsManager->baseUrl('templates/default/style.css'); ?>">
        ...
        <aside class="sidebar">
            <div class="sidebar-logo">
                <a href="<?= $cmsManager->baseUrl(); ?>">
                    <img src="<?= $cmsManager->baseUrl('templates/default/assets/images/logo.png'); ?>" alt="L1QUID.CORE CMS Logo">
                </a>
            </div>
            <nav>
